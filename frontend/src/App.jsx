...
function App() {
  ...
  return (
    <div className="container-fluid min-vh-100 d-flex flex-column align-items-center py-5" style={{ backgroundColor: "#f8f9fa" }}>
      <h1 className="text-center mb-4 text-dark fw-bold">User Management</h1>
      
      <div className="w-75">
        {/* Create User Section */}
        <div className="card p-4 shadow-sm mb-4 bg-white border-0 rounded-3">
